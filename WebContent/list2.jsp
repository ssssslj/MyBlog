...
<article>
 ...
 <div class="search">
    ...
    <div class="fenlei">
      <h2>文章分类</h2>
      <ul>
        <li><a href="article_showlist?type=2">Java（33）</a></li>
        <li><a href="article_showlist?type=3">JavaWeb（19）</a></li>
        <li><a href="article_showlist?type=4">Android（520）</a></li>
        <li><a href="article_showlist?type=5">Linux（40）</a></li>
        <li><a href="article_showlist?type=6">算法（3）</a></li>
        <li><a href="article_showlist?type=7">电脑相关（66）</a></li>
      </ul>
    </div>
    <div class="tuijian">
      <h2>站长推荐</h2>
...
<div class="cloud">
  ...
  <c:forEach var="article" items="${pageBean.articleList }">
    ...
    <a href="article_showlist?type=1&currentPage=${pageBean.currentPage-1}">上一页</a>
    <c:forEach var="i" begin="${begin }" end="${end }">
    	<c:if test="${i== pageBean.currentPage}">
    		<a href="#" class="curPage">${i}</a>&nbsp;&nbsp;
    	</c:if>
    	<c:if test="${i!= pageBean.currentPage}">
    		<a href="article_showlist?type=1&currentPage=${i}">${i}</a>&nbsp;&nbsp;
    	</c:if>
    </c:forEach>
    
    <a href="article_showlist?type=1&currentPage=${pageBean.currentPage+1}" >下一页</a></div>
  </main>
</article>
<footer>
