        ...
        <div class="left-sidebar">
            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-nav-link">
                    <a href="<%=basePath %>/dark/admin/index.jsp" class="active">
                        <i class="am-icon-home sidebar-nav-link-logo"></i> 首页
                    </a>
                </li>
                <li class="sidebar-nav-link">
                    <a href="<%=basePath %>/dark/admin/tables.jsp">
                        <i class="am-icon-table sidebar-nav-link-logo"></i> 表格
                    </a>
                </li>
                <li class="sidebar-nav-link">
                    <a href="<%=basePath %>/dark/admin/calendar.jsp">
                ...
                <li class="sidebar-nav-link">
                    <a href="<%=basePath %>/dark/admin/form2.jsp">
                        <i class="am-icon-wpforms sidebar-nav-link-logo"></i> 相册

                    </a>
                </li>
                <li class="sidebar-nav-link">
                    <a href="<%=basePath %>/dark/admin/chart.jsp">
                ...
                <li class="sidebar-nav-link">
                    <a href="<%=basePath %>/dark/admin/sign-up.jsp">
                        <i class="am-icon-clone sidebar-nav-link-logo"></i> 注册
                        <span class="am-badge am-badge-secondary sidebar-nav-link-logo-ico am-round am-fr am-margin-right-sm">6</span>
                    </a>
                </li>
                <li class="sidebar-nav-link">
                    <a href="<%=basePath %>/dark/admin/login.jsp">
                        <i class="am-icon-key sidebar-nav-link-logo"></i> 登录
                    </a>
                </li>
                <li class="sidebar-nav-link">
                    <a href="<%=basePath %>/dark/admin/404.jsp">
                ...
                <div class="row am-cf">
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-4 widget-margin-bottom-lg ">
                        <div class="tpl-user-card am-text-center widget-body-lg">
                            ...
                            <img class="achievement-image" src="<%=basePath %>/dark/admin/assets/img/user07.png" alt="">
