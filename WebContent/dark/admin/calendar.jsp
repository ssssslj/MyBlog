...
<head>
    ...
    <link rel="stylesheet" href="<%=basePath %>/dark/admin/assets/css/fullcalendar.min.css" />
    <link rel="stylesheet" href="<%=basePath %>/dark/admin/assets/css/fullcalendar.print.css" media='print' />
    ...
    <div class="am-g tpl-g">
        ...
        <div class="left-sidebar">
            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-nav-link">
                    <a href="calendar.jsp" class="active">
