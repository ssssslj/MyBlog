    ...
    <div class="am-g tpl-g">
        ...
        <div class="left-sidebar">
            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-nav-link">
                    <a href="article_showDarkArticleList?type=1">
                        <i class="am-icon-wpforms sidebar-nav-link-logo"></i> 文章

                    </a>
                </li>
                <li class="sidebar-nav-link">
                    <a href="form2.jsp" class="active">
                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            ...
                            <div class="widget-body am-fr">
                                ...
                                <form action="album_saveAlbum" method="post" class="am-form tpl-form-border-form tpl-form-border-br">
                                    <div class="am-form-group">
                                        <label for="user-name" class="am-u-sm-3 am-form-label">标题 <span class="tpl-form-line-small-title">Title</span></label>
                                        <div class="am-u-sm-9">
                                            <input type="text" name="album.title" class="tpl-form-input" id="user-name" placeholder="请输入标题文字">
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" name="album.date" class="am-form-field tpl-form-no-bg" placeholder="发布时间" data-am-datepicker="" readonly="">
                                            <small>发布时间为必填</small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" name="album.digest" placeholder="输入摘要">
                                        </div>
                                    </div>
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <div class="am-form-group am-form-file">
												...
												<input type="text" id="pictureUpload" name="album.img"  />
                                    ...
                                    <div class="am-form-group">
                                        <label for="user-weibo" class="am-u-sm-3 am-form-label">内容图 <span class="tpl-form-line-small-title">Images</span></label>
                                        <div class="am-u-sm-9">
                                            <div class="am-form-group am-form-file">
                                                <script id="uploadEditor1" type="text/plain"></script>
												<input type="text" id="pictureUpload1" name="album.imgs"  />
												<input type="button" id="upImage1" value="上传图片"> 
                                            </div>
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <script id="editor" type="text/plain" name="album.content" style="width:890px;height:500px;"></script>
                                        </div>
                                ...
                                <script type="text/javascript">
									...
									<script type="text/javascript">
										...
										$(function() {
											//重新实例化一个编辑器，防止在上面的editor编辑器中显示上传的图片或者文件
											_uploadEditor1 = UE.getEditor('uploadEditor1');
											_uploadEditor1.ready(function() {
												//设置编辑器不可用
												//_uploadEditor.setDisabled();
												//隐藏编辑器，因为不会用到这个编辑器实例，所以要隐藏
												_uploadEditor1.hide();
												//侦听图片上传
												_uploadEditor1.addListener('beforeInsertImage',
												function(t, arg) {
													//将地址赋值给相应的input,只去第一张图片的路径
													var s = "";
													for (var i = 0; i < arg.length; i++) {
													...
													;
													$("#pictureUpload1").attr("value", s);
												})
												//侦听文件上传，取上传文件列表中第一个上传的文件的路径
												_uploadEditor1.addListener('afterUpfile', function(t, arg) {
													$("#fileUpload1").attr("value",
																	_uploadEditor1.options.filePath + arg[0].url);
												})
											});
										});
										//弹出图片上传的对话框
										$('#upImage1').click(function() {
											var myImage = _uploadEditor1.getDialog("insertimage");
											myImage.open();
										});
										
										//弹出文件上传的对话框
										function upFiles() {
											var myFiles = _uploadEditor1.getDialog("attachment");
											myFiles.open();
										}
									</script>
                            </div>
