...
<body data-type="widgets">
    ...
    <div class="am-g tpl-g">
        ...
        <header>
            <!-- logo -->
            <div class="am-fl tpl-header-logo"> 吧   
                                    ...
                                    <div class="am-form-group">
                                        <div class="am-btn-toolbar">
                                            <div class="am-btn-group am-btn-group-xs">
                                                <button type="button" onclick="f1();" class="am-btn am-btn-default am-btn-success"><span class="am-icon-plus"></span> 新增</button>
                                                <button type="button" class="am-btn am-btn-default am-btn-secondary"><span class="am-icon-save"></span> 保存</button>
                                                <button type="button" class="am-btn am-btn-default am-btn-warning"><span class="am-icon-archive"></span> 审核</button>
                                                <button type="button" class="am-btn am-btn-default am-btn-danger"><span class="am-icon-trash-o"></span> 删除</button>
                                            <script type="text/javascript">
                                            	function f1(){
                                            		window.open('<%=basePath%>/dark/admin/form.jsp');
                                            	}
                                            </script>
                                            </div>
                                        </div>
	...
	<c:choose>
    	<c:when test="${darkPageBean.totalPage<=9}">
    		<c:set var="begin" value="1"/>
    		<c:set var="end" value="9"/>
    	</c:when>
    	<c:otherwise>
    		<c:set var="begin" value="${darkPageBean.totalPage-4}"/>
    		<c:set var="end" value="${darkPageBean.totalPage+4}"/>
    		...
    		<!-- 尾溢出 -->
    		<c:if test="${end>darkPageBean.totalPage}">
    			<c:set var="begin" value="${darkPageBean.totalPage-8}"/>
    			<c:set var="end" value="${darkPageBean.totalPage }"/>
    		</c:if>
    	</c:otherwise>
    </c:choose>
                                <div class="am-u-sm-12">
                                    <table width="100%" class="am-table am-table-compact am-table-striped tpl-table-black " id="example-r">
                                        ...
                                        <tbody>
                                        <c:forEach var="article" items="${darkPageBean.articleList }">
                                            <tr class="even gradeC">
                                                ...
                                                <td>
                                                    <div class="tpl-table-black-operation">
                                                        <a href="article_showDarkContent?aid=${article.aid }">
                                                            <i class="am-icon-pencil"></i> 编辑
                                                        </a>
                                                        <a href="javascript:ale();" class="tpl-table-black-operation-del">
                                ...
                                <div class="am-u-lg-12 am-cf">
                                    ...
                                    <div class="am-fr">
                                        <ul class="am-pagination tpl-pagination">
                                            <li class="am-disabled"><a href="article_showlist?type=0&currentPage=${darkPageBean.currentPage+1}">«</a></li>
                                             <c:forEach var="i" begin="${begin }" end="${end }">
                                             	<c:if test="${i== darkPageBean.currentPage}">
                                             		<li class="am-active"><a href="#">${i}</a></li>
                                             	</c:if>
                                             	<c:if test="${i!= darkPageBean.currentPage}">
                                             		<li><a href="article_showlist?type=0&currentPage=${i}">${i}</a></li>
    												
    											</c:if>
                                           
                                            </c:forEach>
                                            <li><a href="article_showlist?type=0&currentPage=${darkPageBean.currentPage+1}">»</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
