            ...
            <div class="tpl-login-content">
                ...
                <form action="login" method="post" class="am-form tpl-form-line-form">
                    <div class="am-form-group">
                        <input type="text" name="user.username" class="tpl-form-input" id="user-name" placeholder="请输入账号">

                    </div>

                    <div class="am-form-group">
                        <input type="password" name="user.password" class="tpl-form-input" id="user-name" placeholder="请输入密码">
